...
export default function Navbar() {
  ...
  return (
    <nav className="h-16 absolute top-6 left-1/2 transform mb-10 -translate-x-1/2 md:absolute md:top-2 md:right-10 md:mt-6 md:mr-6 md:left-auto md:transform-none">
