...
export default function Particles({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      stars.current.forEach((star: Star, i: number) => {
        const edge = [
          star.x + star.translateX - star.size,
          canvasSize.current.w - star.x - star.translateX - star.size,
          star.y + star.translateY - star.size,
          canvasSize.current.h - star.y - star.translateY - star.size,
        ];
  ...
  }, [amount, dpr, ease, refresh, staticity]);
